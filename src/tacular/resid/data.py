"""Auto-generated RESID data"""
# DO NOT EDIT - generated by gen_resid.py

__all__ = ["VERSION", "RESID_MODIFICATIONS", "RESID_NAME_TO_ID"]
...
try:
    ...
    raise ImportError(f"tacular: the bundled RESID data failed to load: {e}") from e
