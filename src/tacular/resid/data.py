...
try:
    ...
    RESID_NAME_TO_ID: dict[str, str] = {mod.name: mod.id for mod in RESID_MODIFICATIONS.values()}
except Exception as e:
    warnings.warn(f"Exception in resid_data: {e}. Using empty dictionaries.", UserWarning, stacklevel=2)
    RESID_MODIFICATIONS: dict[str, ResidInfo] = {}
