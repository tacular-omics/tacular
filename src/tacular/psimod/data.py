...
try:
    ...
    PSI_NAME_TO_ID: dict[str, str] = {mod.name: mod.id for mod in PSI_MODIFICATIONS.values()}
except Exception as e:
    warnings.warn(f"Exception in psimod_data: {e}. Using empty dictionaries.", UserWarning, stacklevel=2)
    PSI_MODIFICATIONS: dict[str, PsimodInfo] = {}
