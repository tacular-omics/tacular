...
__all__ = ["NeutralDelta", "NeutralDeltaLiteral", "NEUTRAL_DELTA_DICT"]
...
NeutralDelta.FORMAMIDE: NeutralDeltaInfo(
    ...
    monoisotopic_mass=-45.02146372069,
    average_mass=-45.04066629466666,
    dict_composition={'H': -3, 'C': -1, 'O': -1, 'N': -1},
),
NeutralDelta.FORMIC_ACID: NeutralDeltaInfo(
    ...
    description="From -COOH groups",
    amino_acids=frozenset(['D', 'E']),
    monoisotopic_mass=-46.0054793036,
    average_mass=-46.02542725348336,
